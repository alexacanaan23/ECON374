...
%PART A
syms d a b c t Q
syms PP; PP=(c+d*Q)/(1-t)
syms CP; CP=a-b*Q
syms Q_star;Q_star=(a*(1-t)-c)/(b*(1-t)+d)
syms P_star;P_star=(a-b*(Q_star))
syms PP_star;PP_star=subs(PP,Q,Q_star)

%PART B
syms diff_P_star_t;diff_P_star_t=diff(P_star,t)
syms diff_PP_star_t;diff_PP_star_t=diff(PP_star,t)
syms diff_Q_star_t;diff_Q_star_t=diff(Q_star,t)

%PART D
syms TRC;TRC=P_star*Q_star
syms diff_TRC_t;diff_TRC_t=diff(TRC,t)
%%
%Problem 5
clear
syms L u B pi
...
syms q1_star;q1_star=subs(FOC1,q2,q2_BR)
syms q2_star;q2_star=subs(FOC2,q1,q1_BR)
...
%PART E
syms diffv2_difference_q1_q2;diffv2_difference_q1_q2=diff(difference_q1_q2,v2)
